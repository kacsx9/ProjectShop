...
namespace ProjektSklep
{
    public class AttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AttachmentId,Path,Description")] Attachment attachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AttachmentId,Path,Description")] Attachment attachment)
        {
