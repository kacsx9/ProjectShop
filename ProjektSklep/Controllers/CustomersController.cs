...
namespace ProjektSklep
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,LastName,Login,Password,Email,AddressId,PageConfigurationId,AdminRights")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FirstName,LastName,Login,Password,Email,AddressId,PageConfigurationId,AdminRights")] Customer customer)
        {
